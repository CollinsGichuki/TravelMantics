    ...
    public DealAdapter(){
        ...
        mChildeEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                //Getting the location of the data(dataSnapshot) and putting it into the TravelDeal class
        ...
        mDatabaseReference.addChildEventListener(mChildeEventListener);
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private void showImage(String url){
            if(url != null && url.isEmpty() == false){
                Picasso.get().load(url).resize(300, 280).centerCrop().into(imageDeal);
            }
            }
        }
    }
